...
<head>
    ...
    <style>
        ...
        /* Pour gagner de la place, je te donne la version complète de promotions.php avec les mêmes styles */
...
<body>
    ...
    <section class="page-hero">
        <div class="container">
            ...
            <p>Profitez de nos offres exclusives sur une sélection de produits.</p>
        </div>
    </section>
