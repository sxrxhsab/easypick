...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($nom) || empty($email) || empty($sujet) || empty($message)) {
        ...
        // Envoyer l'email avec PHPMailer (fonction existante dans config-email.php)
        $destinataire = 'sabeursarah66@gmail.com'; // À modifier selon tes besoins
        $corps = "Nom : $nom\nEmail : $email\n\nMessage :\n$message";
        ...
        try {
            ...
            $mail->Subject = 'Contact EasyPick : ' . $sujet;
            ...
            $erreur = '❌ Erreur d\'envoi : ' . $mail->ErrorInfo;
        }
    }
}
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Navbar simple (identique aux autres pages) */
        .navbar-simple {
        ...
        .form-group input:focus, .form-group textarea:focus { border-color: #ff6a00; box-shadow: 0 0 0 3px rgba(255,106,0,0.06); }
        ...
        <div class="container">
            <div class="contact-grid">
                ...
                <div class="contact-info">
                    ...
                    <div class="item"><i class="fas fa-clock"></i><span>Lun–Ven : 9h – 18h</span></div>
                </div>
                ...
                <div class="contact-form">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            <label>Sujet *</label>
                            <input type="text" name="sujet" required placeholder="Sujet de votre message" />
                        </div>
                        <div class="form-group">
                            <label>Message *</label>
                            <textarea name="message" required placeholder="Écrivez votre message ici..."></textarea>
                        </div>
